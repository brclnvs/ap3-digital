...
entity mse_tb_mult is
end entity mse_tb_mult;

architecture sim of mse_tb_mult is
...
-- Pulso de start (único)
    ...
    begin
        ...
        report "=== [MULT] Testbench concluido ===" severity note;
        wait;
    end process p_stim;
